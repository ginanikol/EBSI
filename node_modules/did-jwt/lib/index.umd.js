(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('uint8arrays'), require('multiformats/basics'), require('@noble/curves/ed25519'), require('multiformats'), require('@noble/hashes/sha256'), require('@noble/hashes/ripemd160'), require('@noble/hashes/sha3'), require('uint8arrays/from-string'), require('uint8arrays/to-string'), require('uint8arrays/concat'), require('@noble/curves/secp256k1'), require('@noble/curves/p256'), require('canonicalize'), require('did-resolver'), require('@scure/base'), require('@noble/ciphers/chacha'), require('@noble/hashes/utils')) :
  typeof define === 'function' && define.amd ? define(['exports', 'uint8arrays', 'multiformats/basics', '@noble/curves/ed25519', 'multiformats', '@noble/hashes/sha256', '@noble/hashes/ripemd160', '@noble/hashes/sha3', 'uint8arrays/from-string', 'uint8arrays/to-string', 'uint8arrays/concat', '@noble/curves/secp256k1', '@noble/curves/p256', 'canonicalize', 'did-resolver', '@scure/base', '@noble/ciphers/chacha', '@noble/hashes/utils'], factory) :
  (global = global || self, factory(global.didJwt = {}, global.uint8Arrays, global.basics, global.ed25519, global.multiformats, global.sha256$1, global.ripemd160, global.sha3, global.fromString, global.toString, global.concat, global.secp256k1, global.p256, global.canonicalize, global.didResolver, global.base, global.chacha, global.utils));
}(this, (function (exports, uint8arrays, basics, ed25519, multiformats, sha256$1, ripemd160, sha3, fromString, toString, concat, secp256k1, p256, canonicalizeData, didResolver, base, chacha, utils) {
  ...
  function bytesToMultibase(b, base = 'base58btc', codec) {
    if (!codec) {
      return basics.bases[base].encode(b);
    } else {
      ...
      return basics.bases[base].encode(multicodecEncoding);
    }
  }
  /**
  ...
  function multibaseToBytes(s) {
    ...
    const baseDecoder = base58btc.decoder.or(base10.decoder).or(base16.decoder).or(base16upper.decoder).or(base64.decoder).or(base64url.decoder);
    const bytes = baseDecoder.decode(s); // look for known key lengths first
