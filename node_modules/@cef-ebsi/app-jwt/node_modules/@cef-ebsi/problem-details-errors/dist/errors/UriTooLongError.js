...
class UriTooLongError extends ProblemDetailsError_1.ProblemDetailsError {
     ...
     */
    constructor(title = UriTooLongError.defaultTitle, options) {
        super(UriTooLongError.statusCode, title, options);
        this.name = "UriTooLongError";
    }
}
exports.UriTooLongError = UriTooLongError;
UriTooLongError.statusCode = 414;
UriTooLongError.defaultTitle = "URI Too Long";
exports.default = UriTooLongError;
//# sourceMappingURL=UriTooLongError.js.map