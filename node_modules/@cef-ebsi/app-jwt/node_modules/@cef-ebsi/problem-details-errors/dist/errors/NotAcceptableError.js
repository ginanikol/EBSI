...
/**
 * NotAcceptableError defines the Not Acceptable (406) error type.
 */
class NotAcceptableError extends ProblemDetailsError_1.ProblemDetailsError {
    /**
     ...
     */
    constructor(title = NotAcceptableError.defaultTitle, options) {
        super(NotAcceptableError.statusCode, title, options);
        this.name = "NotAcceptableError";
    }
}
exports.NotAcceptableError = NotAcceptableError;
NotAcceptableError.statusCode = 406;
NotAcceptableError.defaultTitle = "Not Acceptable";
