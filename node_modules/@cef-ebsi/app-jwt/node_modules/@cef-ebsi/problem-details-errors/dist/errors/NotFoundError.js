 ...
 */
class NotFoundError extends ProblemDetailsError_1.ProblemDetailsError {
    /**
     ...
     */
    constructor(title = NotFoundError.defaultTitle, options) {
...
NotFoundError.defaultTitle = "Not Found";
