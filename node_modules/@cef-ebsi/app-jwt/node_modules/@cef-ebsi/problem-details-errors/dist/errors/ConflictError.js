 ...
 */
class ConflictError extends ProblemDetailsError_1.ProblemDetailsError {
    /**
     ...
     */
    constructor(title = ConflictError.defaultTitle, options) {
...
ConflictError.defaultTitle = "Conflict";
