 ...
 */
class PayloadTooLargeError extends ProblemDetailsError_1.ProblemDetailsError {
    /**
     ...
     */
    constructor(title = PayloadTooLargeError.defaultTitle, options) {
...
PayloadTooLargeError.defaultTitle = "Payload Too Large";
