 ...
 */
class BadRequestError extends ProblemDetailsError_1.ProblemDetailsError {
    /**
     ...
     */
    constructor(title = BadRequestError.defaultTitle, options) {
...
BadRequestError.defaultTitle = "Bad Request";
