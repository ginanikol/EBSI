...
/**
 * PaymentRequiredError defines the Payment Required (402) error type.
 */
class PaymentRequiredError extends ProblemDetailsError_1.ProblemDetailsError {
    /**
     ...
     */
    constructor(title = PaymentRequiredError.defaultTitle, options) {
        super(PaymentRequiredError.statusCode, title, options);
        this.name = "PaymentRequiredError";
    }
}
exports.PaymentRequiredError = PaymentRequiredError;
PaymentRequiredError.statusCode = 402;
PaymentRequiredError.defaultTitle = "Payment Required";
