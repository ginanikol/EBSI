...
exports.RangeNotSatisfiableError = void 0;
const ProblemDetailsError_1 = require("./ProblemDetailsError");
/**
 * RangeNotSatisfiableError defines the Range Not Satisfiable (416) error type.
 */
class RangeNotSatisfiableError extends ProblemDetailsError_1.ProblemDetailsError {
    /**
     ...
     */
    constructor(title = RangeNotSatisfiableError.defaultTitle, options) {
        super(RangeNotSatisfiableError.statusCode, title, options);
        this.name = "RangeNotSatisfiableError";
    }
}
exports.RangeNotSatisfiableError = RangeNotSatisfiableError;
RangeNotSatisfiableError.statusCode = 416;
RangeNotSatisfiableError.defaultTitle = "Range Not Satisfiable";
exports.default = RangeNotSatisfiableError;
//# sourceMappingURL=RangeNotSatisfiableError.js.map