...
/**
 * UnauthorizedError defines the Unauthorized (401) error type.
 */
class UnauthorizedError extends ProblemDetailsError_1.ProblemDetailsError {
    /**
     ...
     */
    constructor(title = UnauthorizedError.defaultTitle, options) {
...
UnauthorizedError.defaultTitle = "Unauthorized";
